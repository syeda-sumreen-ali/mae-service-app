...
class ImagePickerComponent extends Component {
  ...
  handleChoosePhoto = () => {
    ...
    if (this.props.openfrom === 'add_photos_to_experience') {
      ...
      this.setState({ options: defaultOptions }, () => this.openGallery())
            ...
            [
              {
                text: 'Take Photo...',
                onPress: () =>
                  this.setState({ isModalVisible: false }, this.openCamera())
              },
              {
                text: 'Choose from Library...',
                onPress: () =>
                  this.setState({ isModalVisible: false }, this.openGallery())
              },
              {
                text: 'Cancel',
          ...
          {this.state.file || displayImage ? (
            <>
              ...
              {!this.props.hideAddPhotoBtn && (
                ...
                >
                  <FastImage
                    source={IMAGES.icons_actions_add_photo}
                    resizeMode='contain'
